...
public class LargestProductInSeries2 {
    ...
    private final static int SEQUENCE_LENGTH = 13;
    ...
    private static void getSequence() {
        ...
        while (end < NUMBER.length() && length < SEQUENCE_LENGTH) {
    ...
    private static void calculateProduct() {
        int result = 1;
        if (end < NUMBER.length() && NUMBER.charAt(end) != '0') {
